...
export function DigitsAndRootsPage() {
  ...
  return (
    <div className="py-2 space-y-5">
      ...
      <div>
        <motion.h3
          className="text-lg text-aurora-yellow font-bold mb-3 text-center"
        ...
        {!rolling && (
          ...
          >
            ...
            <span className="text-xl font-bold text-aurora-yellow" style={{ fontFamily: 'var(--font-display)' }}>
              73!
            </span>
      ...
      <div>
        <motion.h3
          className="text-lg text-aurora-purple font-bold mb-3 text-center"
          style={{ fontFamily: 'var(--font-display)' }}
          initial={{ opacity: 0, y: -10 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          >
            ...
            <span className="text-2xl font-bold text-aurora-purple" style={{ fontFamily: 'var(--font-display)' }}>
              √144
            </span>
            <span className="text-white/50 text-sm" style={{ fontFamily: 'var(--font-body)' }}>
              {' '}?
          ...
          {rootAnswer && (
            ...
            >
              <div className="flex items-center justify-center gap-2">
                <span className="text-3xl font-bold text-aurora-purple" style={{ fontFamily: 'var(--font-display)' }}>
                  12
                </span>
                <span className="text-aurora-green text-xl">✓</span>
              </div>
              <p className="text-xs text-aurora-green/70 mt-1" style={{ fontFamily: 'var(--font-body)' }}>
                +3 spaces!
              </p>
            </motion.div>
          )}
